...
def preprocess_image(file, train_or_test, output_path):
    if file.endswith('.jpeg') & (os.path.getsize(input_path + file) > 0):
        ...
        if train_or_test == 'train':
            ...
            rot_45 = rotateImage(enh_img, 45)
            rot_90 = rotateImage(enh_img, 90)
            rot_270 = rotateImage(enh_img, 270)

            rot_flipped_45 = rotateImage(flipped_img, 45)
            rot_flipped_90 = rotateImage(flipped_img, 90)
            rot_flipped_270 = rotateImage(flipped_img, 270)
